...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = managedObjects[indexPath.row].value(forKeyPath: "nombre") as? String
        return cell
    }
    ...
    func registrarNombre(nombre: String) { // en esta funcion pasamos por parámetro el nombre del alumno
        ...
        // 1. creamos un objeto de tipo "NSManagedObject" usando la clase de entity.
        ...
        managedObject.setValue(nombre, forKeyPath: "nombre")// forKeyPath: el nombre del atributo
